...
// /tmp/serviceweaver/logs. We recommend that deployers store their logs in a
// directory within this default directory. For example, the "weaver multi"
// deployer stores its data in /tmp/serviceweaver/logs/multi.
func LogsDir() string {
